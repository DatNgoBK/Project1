...
public class DangNhapForm extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        MainForm.jTabbedPane1.removeAll();
        MainForm.jTabbedPane1.add("Admin", new AdminMenuForm());
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new MainForm().setVisible(true);
        MainForm.jTabbedPane1.removeAll();
        MainForm.jTabbedPane1.add("Guest", new GuestMenuForm());
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DangNhapForm dialog = new DangNhapForm();
